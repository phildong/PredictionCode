...
def main():
    CALC_PVALS = False # Do we calculate p-values? This takes orders of magintude longer
    ...
    for neuron in np.arange(numNeurons):
        ...
        A, phi[neuron], c, p_phase[neuron], r2_phase[neuron], rho2_phase[neuron] = check_cosine_tuning(phase, activity[neuron, :], pval=CALC_PVALS)
        ...
        A, phi_pos[neuron], c, p_posphase[neuron], r2_posphase[neuron], rho2_posphase[neuron] = check_cosine_tuning(pos_phase, activity[neuron, :], pval=CALC_PVALS)
        ...
        A, phi_neg[neuron], c, p_negphase[neuron], r2_negphase[neuron], rho2_negphase[neuron] = check_cosine_tuning(neg_phase, activity[neuron, :], pval=CALC_PVALS)
