...
AVA_neuron1 = 17 #44 #for dataset 172538
AVA_neuron2 = 81 #53 #for dataset 172538
...
def get_data(start_frame, end_frame, neurons, neurons_withNaN, neurons_Zscore, time, time_contig, velocity):
    ...
    neuron_NaN_data = neurons_withNaN[:, start_frame:end_frame]
    zscore_neuron = neurons_Zscore[:, start_frame:end_frame]
    [row, column] = neurons.shape
    neuron_num = list(range(0, row, 1))
    crop_velocity = velocity[start_index:end_index] #velocity is non-contiguous
...
def do_residual(moving_worm, immobile_worm):
    ...
    residual = immobile_worm-moving_worm
    return residual
...
def get_index_after_NaN(old_index, index_list):
    #Take the full dataset and count how many NaNs will be removed to get to index of interest (AVA). Subtract accordingly
    count = len([i for i in index_list if i < old_index])
...
def remove_and_cluster_and_residual(matrix_move, matrix_immobile, index_list):
    ...
    new_AVA_index_noNaN1 = get_index_after_NaN(AVA_neuron1, index_list)
    new_AVA_index_noNaN2 = get_index_after_NaN(AVA_neuron2, index_list)
    movecluster_AVA_index1 = get_index_AVA_clustered(new_AVA_index_noNaN1, moving_cgIdx)
    movecluster_AVA_index2 = get_index_AVA_clustered(new_AVA_index_noNaN2,moving_cgIdx)
    movecluster_AVA = [movecluster_AVA_index1, movecluster_AVA_index2]
    immcluster_AVA_index1 = get_index_AVA_clustered(new_AVA_index_noNaN1, immobile_cgIdx)
    immcluster_AVA_index2 = get_index_AVA_clustered(new_AVA_index_noNaN2,immobile_cgIdx)
...
for typ_cond in ['AKS297.51_transition']: #, 'AKS297.51_moving']:
    ...
    AVA_index_imm1 = get_index_AVA_clustered(AVA_neuron1, cgIdx_immobile)
    AVA_index_imm2 = get_index_AVA_clustered(AVA_neuron2, cgIdx_immobile)
    ...
    AVA_index_mov1 = get_index_AVA_clustered(AVA_neuron1, cgIdx_moving)
    AVA_index_mov2 = get_index_AVA_clustered(AVA_neuron2, cgIdx_moving)
    ...
    AVA_label = [AVA_neuron1, AVA_neuron2] #For dataset 144610
   #PLOTTING
    ...
    plt.colorbar()
    plt.title('Correlation_172538_moving')
    ...
    plt.colorbar()
    plt.title('Correlation_172538_immobile')
    plt.xlabel('Sorted Neuron')
    plt.ylabel('Sorted Neuron')
    plt.xticks([AVA_index_imm1,AVA_index_imm2], AVA_label)
    plt.yticks([AVA_index_imm1, AVA_index_imm2], AVA_label)
    ...
    plt.colorbar()
    plt.title('Residual_immobile-moving_172538')
    plt.xlabel('Sorted Neuron')
    plt.ylabel('Sorted Neuron')
    plt.xticks([AVA_index_imm1,AVA_index_imm2], AVA_label)
    plt.yticks([AVA_index_imm1, AVA_index_imm2], AVA_label)
    ...
    plt.title('AVA Correlation AVA_neuron44_172538_moving')
    plt.xlabel('Neuron')
    ...
    plt.title('AVA Correlation 44_172538_immobile')
    plt.xlabel('Neuron')
    plt.ylabel('Correlation')
    plt.ylim(-0.8, 1)
    plt.grid()
    ...
    plt.title('AVA Correlation 53_172538_moving')
    plt.xlabel('Neuron')
    plt.ylabel('Correlation')
    plt.ylim(-0.8, 1)
    plt.grid()
    ...
    plt.title('AVA Correlation 53_172538_immobile')
    plt.xlabel('Neuron')
    plt.ylabel('Correlation')
    plt.ylim(-0.8, 1)
    plt.grid()
    ...
    plt.title('AVA R^2 44_172538_moving')
    plt.xlabel('Neuron')
    plt.ylabel('R^2')
    plt.ylim(0, 1)
    plt.grid()
    ...
    plt.title('AVA R^2 44_172538_immobile')
    plt.xlabel('Neuron')
    plt.ylabel('R^2')
    plt.ylim(0, 1)
    plt.grid()
    ...
    plt.title('AVA R^2 53_172538_moving')
    plt.xlabel('Neuron')
    plt.ylabel('R^2')
    plt.ylim(0, 1)
    plt.grid()
    ...
    plt.title('AVA R^2 53_172538_immobile')
    plt.xlabel('Neuron')
    plt.ylabel('R^2')
    plt.ylim(0, 1)
    plt.grid()
    ...
    plt.colorbar()
    plt.title('R_Square_172538_moving')
    plt.xlabel('Sorted Neuron')
    plt.ylabel('Sorted Neuron')
    plt.xticks([AVA_index_mov1,AVA_index_mov2], AVA_label)
    plt.yticks([AVA_index_mov1, AVA_index_mov2], AVA_label)
    ...
    plt.colorbar()
    plt.title('R_Square_172538_immobile')
    plt.xlabel('Sorted Neuron')
    plt.ylabel('Sorted Neuron')
    plt.xticks([AVA_index_mov1,AVA_index_mov2], AVA_label)
    plt.yticks([AVA_index_mov1, AVA_index_mov2], AVA_label)
    ...
    #plt.colorbar()
    plt.title('Moving_172538_Immobile Cluster')
    ...
    #plt.colorbar()
    plt.title('Immobile_172538_Immobile Cluster')
    plt.xlabel('Time (sec/6)')
    plt.ylabel('Sorted Neuron')
    ...
    #plt.colorbar()
    plt.title('Mov_ZScore_172538_Immobile Cluster')
    plt.xlabel('Time (sec/6)')
    plt.ylabel('Sorted Neuron')
    ...
    #plt.colorbar()
    plt.title('Imm_Zscore_172538_Immobile Cluster')
    plt.xlabel('Time (sec/6)')
    plt.ylabel('Sorted Neuron')
    ...
    #plt.colorbar()
    plt.title('Moving_172538_Moving Cluster')
    plt.xlabel('Time (sec/6)')
    plt.ylabel('Sorted Neuron')
    ...
    #plt.colorbar()
    plt.title('Immobile_172538_Moving Cluster')
    plt.xlabel('Time (sec/6)')
    plt.ylabel('Sorted Neuron')
    ...
    #plt.colorbar()
    plt.title('Mov_ZScore_172538_Moving Cluster')
    plt.xlabel('Time (sec/6)')
    plt.ylabel('Sorted Neuron')
    ...
    #plt.colorbar()
    plt.title('Imm_ZScore_172538_Moving Cluster')
    plt.xlabel('Time (sec/6)')
    plt.ylabel('Sorted Neuron')
    ...
    plt.colorbar()
    plt.title('Move_172538_AvgCorr ='+str(move_noNaN_avg_corr))
    ...
    plt.colorbar()
    plt.title('Imm_172538_AvgCorr =' +str(imm_nonNaN_avg_corr))
    plt.xlabel('Sorted Neuron_NaN removed')
    plt.ylabel('Sorted Neuron_NaN removed')
    plt.xticks(mcluster_AVA, AVA_label)
    plt.yticks(mcluster_AVA, AVA_label)
    ...
    plt.subplot(3,1,2)
    plt.plot(moving_data[AVA_neuron1,:]) #, moving_time)
    plt.title('AVA Neuron 44')
    plt.xlabel('time_contig')

    plt.subplot(3,1,3)
    plt.plot(moving_data[AVA_neuron2,:])#, moving_time)
    plt.title('AVA Neuron 53')
    plt.xlabel('time_contig')
    plt.show()
