...
#This is a duplicate of CheckNEuralTRajectories and TransitionAnalysis2018
#But configured for our backup 2020 transition dataset
#This dataset was too short to demonstrate AVA behaved as expected
#But it is still valid and will be included for statistics on moving to immobile transitions
...
for typ_cond in ['AML310_transition']: #, 'AML310_moving']:
    ...
    theDataset = '144610'
    drug_application = 1429
    transition = im_start = 1539
    im_end = 2904
